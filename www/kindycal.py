...
#fair stuff:
    ...
    ('/add', fair.AddName),
#fair redirects, so can do /AdultBottles and get to stall?stall_name=AdultBottles
    ('/AdultBottles',fair.AdultBottlesRedirect),
    ...
    ('/books',fair.BooksRedirect),
    ('/bbq',fair.BurgerServersRedirect),
    ('/bbqcooks',fair.BurgerServersRedirect),
    ('/BBQcooks',fair.BurgerBurnersRedirect),
    ('/cakes',fair.CakesRedirect),
    ('/coffee',fair.CoffeeRedirect),
    ('/drinks',fair.DrinksRedirect),
    ...
    ('/snocones',fair.SnoConesRedirect),
    ('/Snocones',fair.SnoConesRedirect),
    ('/Sushi',fair.SushiRedirect),
    ('/sushi',fair.SushiRedirect),
    ('/SUSHI',fair.SushiRedirect),
    ('/sweettreats',fair.SweetTreatsRedirect),
    ('/Sweettreats',fair.SweetTreatsRedirect),
    ('/sweets',fair.SweetTreatsRedirect),
    ('/Sweets',fair.SweetTreatsRedirect),
    ('/raffle',fair.RaffleRedirect),
    ('/setupfri',fair.SetupFriRedirect),
    ('/setup',fair.SetupFriRedirect),
    ('/Setup',fair.SetupFriRedirect),
    ('/setupsat',fair.SetupSatRedirect),
    ('/setupsun',fair.SetupSunRedirect),
    ('/setupmon',fair.SetupMonRedirect),
